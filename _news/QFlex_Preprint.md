...
<figure style="text-align: center; margin-top: 1.5em;">
  <img src="/assets/img/news_images/quantile_plot.png" alt="IISE Award Presentation" width="500" height="300">
  <figcaption style="margin-top: 0.5em; font-size: 0.9em; color: #555;">
    <strong>Figure.</strong>
    The QFlex system can match a wide variety of distribution shapes and boundedness. Here is it creating density functions from quantiles sampled from a set of bounded distributions.
  </figcaption>
</figure>
<hr>