...
<figure style="text-align: center; margin-top: 1.5em;">
  <img src="/assets/img/news_images/JPSE_conj.png" alt="JPSE_Conj" width="500" height="300">
  <figcaption style="margin-top: 0.5em; font-size: 0.9em; color: #555;">
    <strong>Figure.</strong>
    The derivative of the truncated Johnson SL power-series function with $K$ terms. For odd $K$, the derivative appears to be strictly positive in $z$ for any $\delta > 0$. This (and an analog for the SB power series) is the phenomenon we set out to rigorously prove. Taken from <i>Truncated Johnson Power-Series Quantile Functions</i> (Bickel, 2026).
  </figcaption>
</figure>
<hr>
